...
{
    public class InfoTable : TableLayoutPanel
    {
        ...
        private InfoTable(InfoForm parentForm)
        {
            infoForm = parentForm;
        ...
        public InfoTable(InfoForm parentForm, Employee employee) : this(parentForm)
        {
            editIndex = 0;
        ...
        public InfoTable(InfoForm parentForm, Animal animal) : this(parentForm)
        {
            editIndex = 1;
        ...
        public InfoTable(InfoForm parentForm, Habitat habitat) : this(parentForm)
        {
            editIndex = 2;
        }
        public InfoTable(InfoForm parentForm, Zone zone) : this(parentForm)
        {
            editIndex = 3;
        }
        ...
        public void UpdateControls()
        {
            ...
            if (EditMode)
            {
                ...
                {
                    case 0: //Employee
                        UpdateControls_Employee(row);
                        break;
                    case 1: // Animal
                        UpdateControls_Animal(row);
                        break;
                    case 2: //Habitat
                        UpdateControls_Habitat(row);
                        break;
                    case 3: //Zone
                        UpdateControls_Zone(row);
                        break;
                }
            }
            else
        ...
        private void UpdateControls_Employee(int row)
        {
        ...
        private void UpdateControls_Animal(int row)
        {
            EditControls = new Control[LabelStrings.Length];
        ...
        private void UpdateControls_Habitat(int row)
        {

        }
        private void UpdateControls_Zone(int row)
        {
    ...
    public class aEditButton : Button
    {
        ...
        private InfoTable parentTable;
        private bool EditMode;
        public aEditButton(InfoTable parentTable)
        {
    ...
    public class aRemoveButton : Button
    {
        ...
        public aRemoveButton(InfoTable parentTable)
        {
